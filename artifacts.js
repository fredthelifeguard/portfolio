  ...
  },
{
    ...
    banner: "containment.svg",
    bannerAlt: "Figure titled The Containment Spectrum, placing tools on an axis from tool-agnostic to bias-laden: a pencil at the agnostic end, a sword at the bias-laden end, an epee shown as bias contained by rule and guard, and artificial intelligence spanning the middle as a gradation rather than a point.",
    image: "frameworkpdf.png",
    imageWidth: 935,
    imageHeight: 750,
    imageAlt: "First page of the AI Leadership and Governance Framework PDF, showing the title, an orange divider rule, and the Introduction section establishing that AI is a contained tool rather than a neutral one.",
